                        ...
                        return (
                            <div className="flex gap-1 justify-center">
                                ...
                                {Array.from(Array(columns).keys()).map((column, index) => {
                                    ...
                                    // row = 0, seat = 0, column = 0, -> 0*12 + 0 + 0 -> 0
                                    // row = 1 , seat = 1*12 + 0 + 0 -> 12
                                    let seatClass = "seat";
    ...
    return (
        show && (
            <div>
              ...
              billingAddress
              stripeKey="pk_test_51SlV9bLT8WoaiE2h3JcveluQnOShgKjKFIJXckeBvFatdQOYIwD9A1eIw2yAJFUSq2KESBRFhRKR83m5q9rN28Ti00ziyY1dz2"
            >
